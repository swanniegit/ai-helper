    ...
    <div className="flex">
      <aside className="w-64 bg-white p-4 shadow-md rounded-lg mr-4 animate-slideInLeft">
        ...
        <nav>
          <ul>
            <li className="mb-2">
              <a href="/dashboard" className="block p-2 rounded-md text-gray-700 hover:bg-blue-100 hover:text-blue-700 transition-all duration-200 transform hover:translate-x-1">
                My Progress
              </a>
            </li>
            <li className="mb-2">
              <a href="/chat" className="block p-2 rounded-md text-gray-700 hover:bg-blue-100 hover:text-blue-700 transition-all duration-200 transform hover:translate-x-1 bg-blue-100 text-blue-700">
                AI Mentor
              </a>
            </li>
            <li className="mb-2">
