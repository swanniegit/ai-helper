...
CREATE INDEX idx_learning_paths_career_path ON learning_paths(career_path);
CREATE INDEX idx_skill_assessments_learning_path_id ON skill_assessments(learning_path_id);
CREATE INDEX idx_career_goals_learning_path_id ON career_goals(learning_path_id);
CREATE INDEX idx_priority_areas_learning_path_id ON priority_areas(learning_path_id);
CREATE INDEX idx_learning_plans_learning_path_id ON learning_plans(learning_path_id);
CREATE INDEX idx_plan_quarters_learning_plan_id ON plan_quarters(learning_plan_id);
CREATE INDEX idx_progress_tracking_learning_path_id ON progress_tracking(learning_path_id);
